            ...
            foreach ($produtos as $produtosRow) { //DADOS
                $produtosPrint .= '
                    <tr'.(($resp->id==$produtosRow->id_pro)?' class="Marcar"':'').'>
                        ...
                        <td>
                        <div>
                            <a type="button" class="warning alterar" title="Editar '.$produtosRow->nome_pro.'" href="'.(($route)?$route.'/'.$produtosRow->id_pro.'/editar':'').'"><i class="Editar"></i></a>
                            <a type="button" class="danger  deletar" title="deletar '.$produtosRow->nome_pro.'" href="'.(($route)?$route.'/'.$produtosRow->id_pro:'').'"><i class="Deletar"></i></a>
                        </div>
                        </td>
                    </tr>
                    ';
